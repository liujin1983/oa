...
class ControllerCommonHome extends Controller {   
	public function index() {
		...
		if(!isset($url)||$url=='')
		{
			$this->data['task_menu'] = $this->url->link('task/task', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['task_first'] = $this->url->link('task/task/first', 'token=' . $this->session->data['token'], 'SSL');
		}
		else {
			$this->data['task_menu'] = $this->url->link($url, 'token=' . $this->session->data['token'], 'SSL');
			$this->data['task_first'] = $this->url->link($url.'/first', 'token=' . $this->session->data['token'], 'SSL');
		}
